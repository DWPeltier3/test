...
directory = '/home/donald.peltier/swarm/logs/historical/noise/1'  # Replace with the path to your files
model = 'TRS'
...
output_directory = '/home/donald.peltier/swarm/logs/extracted_data/noise'  # Replace with the path where you want to save the file
out_filename = f'2extracted_data_{model}.txt'
