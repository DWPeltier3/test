function [states] = GreedyPro_D_PV(attacker, defender, defender_v, do_plot, kill_pro, seed, accel, kill_range, rand_start)
    ...
    Def_Velocity_vect=zeros(N_att,2); % used for ProNav
