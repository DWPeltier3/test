...
gaccel=10;           % original greedy defender acceleration steps
...
for seed=1:seedrange
    ...
    %% GREEDY (Pursuit)
    g=Greedy_D_PV(N_attacker,N_defender,Defender_v_max,do_plot,final_fraction,seed,gaccel,kill_range,rand_start);
