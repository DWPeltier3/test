%% Collect & Save Data
% Use this script to run 3 algorithms below using inputs
...
for seed=1:seedrange
    ...
    %% Auction (Pursuit)
    a=Auction_D_PV(N_attacker,N_defender,Defender_v_max,do_plot,final_fraction,seed,gaccel,kill_range,rand_start);

    %% Auction ProNav
    ap=AuctionPro_D_PV(N_attacker,N_defender,Defender_v_max,do_plot,final_fraction,seed,gaccel,kill_range,rand_start);
